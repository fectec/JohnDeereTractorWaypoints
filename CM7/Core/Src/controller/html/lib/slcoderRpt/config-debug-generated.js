...
dojoConfig.packages.push({'name': 'MOTW', 'location': '/ui/webgui/src/MOTW'});
dojoConfig.packages.push({'name': 'MW', 'location': '/ui/webwidgets/src/js/MW'});
dojoConfig.packages.push({'name': 'PMP', 'location': '/ui/pmp/main'});
...
dojoConfig.packages.push({'name': 'addonsdetail-ui', 'location': '/toolbox/matlab/addons_detail/addonsdetail-ui'});
dojoConfig.packages.push({'name': 'addonsprefs-ui', 'location': '/toolbox/matlab/preferences/addonspanel/addonsprefs-ui'});
dojoConfig.packages.push({'name': 'addonssidepanel-ui', 'location': '/toolbox/matlab/addons_sidepanel/addonssidepanel-ui'});
...
dojoConfig.packages.push({'name': 'ai_chat_panel', 'location': '/ui/ai_chat_panel/ai_chat_panel/js'});
...
dojoConfig.packages.push({'name': 'appdesigner_interface', 'location': '/toolbox/matlab/appdesigner/interface_js'});
dojoConfig.packages.push({'name': 'appdesigner_startscreen', 'location': '/toolbox/matlab/appdesigner/startscreen/web'});
dojoConfig.packages.push({'name': 'appdesignerpanel-ui', 'location': '/toolbox/matlab/preferences/appdesignerpanel/appdesignerpanel-ui'});
...
dojoConfig.packages.push({'name': 'cfbprefs-ui', 'location': '/toolbox/matlab/preferences/currentfolderbrowser_prefs/cfbprefs-ui'});
...
dojoConfig.packages.push({'name': 'codegenwidget-ui', 'location': '/toolbox/matlab/graphics/figuredatatools/codegenwidget/codegenwidget-ui'});
...
dojoConfig.packages.push({'name': 'commandhistory', 'location': '/toolbox/matlab/commandhistory/component/web/commandhistory'});
dojoConfig.packages.push({'name': 'commandwindow', 'location': '/toolbox/matlab/commandwindow/js'});
dojoConfig.packages.push({'name': 'commandwindowpanel-ui', 'location': '/toolbox/matlab/preferences/commandwindowpanel/commandwindowpanel-ui'});
...
dojoConfig.packages.push({'name': 'common_serialization', 'location': '/toolbox/matlab/editor/common/serialization/js'});
...
dojoConfig.packages.push({'name': 'comparisons_var_widgets', 'location': '/toolbox/comparisons/var/widgets/comparisons_var_widgets'});
dojoConfig.packages.push({'name': 'comparisons_view_actions', 'location': '/toolbox/comparisons/view/actions/comparisons_view_actions'});
...
dojoConfig.packages.push({'name': 'computils_mockfilechooser', 'location': '/toolbox/shared/computils/mockfilechooser/js/computils_mockfilechooser'});
dojoConfig.packages.push({'name': 'configmanager', 'location': '/toolbox/matlab/configmanager/js'});
dojoConfig.packages.push({'name': 'connections_panel-lib', 'location': '/toolbox/matlab/connections_panel/connections_panel-lib'});
dojoConfig.packages.push({'name': 'cpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/c/cpanel-ui'});
...
dojoConfig.packages.push({'name': 'datatools_sidepanel-lib', 'location': '/toolbox/matlab/datatools/datatools_sidepanel/datatools_sidepanel-lib'});
...
dojoConfig.packages.push({'name': 'debuggerpanel', 'location': '/toolbox/matlab/debuggerpanel/src'});
dojoConfig.packages.push({'name': 'debuggerui', 'location': '/toolbox/matlab/debuggerui/src'});
...
dojoConfig.packages.push({'name': 'desktop_inspector', 'location': '/toolbox/matlab/datatools/desktop_inspector/desktop_inspector'});
...
dojoConfig.packages.push({'name': 'diagnostic-viewer', 'location': '/derived/ui/diagnostic-viewer'});
...
dojoConfig.packages.push({'name': 'editor_actions', 'location': '/toolbox/matlab/editor/cfb_integration/editor_actions/editor_actions'});
dojoConfig.packages.push({'name': 'editor_application_interface', 'location': '/toolbox/matlab/editor/application_interface/js'});
dojoConfig.packages.push({'name': 'editor_open_action', 'location': '/toolbox/matlab/editor/cfb_integration/editor_open_action/editor_open_action'});
dojoConfig.packages.push({'name': 'editorpanels-ui', 'location': '/toolbox/matlab/preferences/editorpanels/editorpanels-ui'});
...
dojoConfig.packages.push({'name': 'embeddedoutputs_nodes', 'location': '/toolbox/matlab/embeddedoutputs/nodes/js'});
...
dojoConfig.packages.push({'name': 'executiondataservice', 'location': '/toolbox/matlab/executiondataservice/js'});
...
dojoConfig.packages.push({'name': 'figurecopyprefspanel-ui', 'location': '/toolbox/matlab/preferences/figurecopyprefspanel/figurecopyprefspanel-ui'});
...
dojoConfig.packages.push({'name': 'findfiles_ui-ui', 'location': '/toolbox/matlab/findfiles_ui/findfiles_ui-ui'});
dojoConfig.packages.push({'name': 'fixedpoint_data', 'location': '/toolbox/matlab/editor_addons/fixedpoint_data/js'});
...
dojoConfig.packages.push({'name': 'folder_preview_plugin', 'location': '/toolbox/matlab/filesystem/default_filetype_plugins/folder_preview_plugin/impl'});
...
dojoConfig.packages.push({'name': 'git_blame_addon', 'location': '/toolbox/shared/cmlink/view/editor/addons/git_blame_addon/js'});
dojoConfig.packages.push({'name': 'gotofile', 'location': '/toolbox/matlab/gotofile/js'});
...
dojoConfig.packages.push({'name': 'inspector_editors-lib', 'location': '/toolbox/matlab/datatools/inspector/editors/js/inspector_editors/inspector_editors-lib'});
...
dojoConfig.packages.push({'name': 'javapanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/java/javapanel-ui'});
dojoConfig.packages.push({'name': 'javascriptpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/javascript/javascriptpanel-ui'});
dojoConfig.packages.push({'name': 'keyboard_shortcuts', 'location': '/toolbox/matlab/keyboard_shortcuts/client'});
dojoConfig.packages.push({'name': 'keyboardshortcutspanel-ui', 'location': '/toolbox/matlab/preferences/keyboardshortcutspanel/keyboardshortcutspanel-ui'});
...
dojoConfig.packages.push({'name': 'livecode_serialization', 'location': '/toolbox/matlab/editor/livecode/serialization/js'});
dojoConfig.packages.push({'name': 'livecodefileviewer', 'location': '/toolbox/matlab/codefileviewer/livecode/widget'});
dojoConfig.packages.push({'name': 'livecodewidget', 'location': '/toolbox/matlab/editor/livecode/widget/js'});
...
dojoConfig.packages.push({'name': 'markdownpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/markdown/markdownpanel-ui'});
...
dojoConfig.packages.push({'name': 'matlab_favorite_commands', 'location': '/toolbox/matlab/matlab_favorite_commands/component/web/matlab_favorite_commands'});
...
dojoConfig.packages.push({'name': 'matlab_maps_vectortileviewer', 'location': '/toolbox/matlab/maps/vectortileviewer/vectortileviewer'});
dojoConfig.packages.push({'name': 'matlab_preferences', 'location': '/toolbox/matlab/matlab_preferences/web/matlab_preferences'});
...
dojoConfig.packages.push({'name': 'matlabcode_filename_validation', 'location': '/toolbox/matlab/editor/cfb_integration/matlabcode_filename_validation/matlabcode_filename_validation'});
dojoConfig.packages.push({'name': 'matlabcode_filepreview', 'location': '/toolbox/matlab/editor/cfb_integration/matlabcode_filepreview/matlabcode_filepreview'});
dojoConfig.packages.push({'name': 'matlabcode_filetype_icons', 'location': '/toolbox/matlab/editor/cfb_integration/matlabcode_filetype_icons/matlabcode_filetype_icons'});
dojoConfig.packages.push({'name': 'matlabcode_filetype_labels', 'location': '/toolbox/matlab/editor/cfb_integration/matlabcode_filetype_labels/matlabcode_filetype_labels'});
...
dojoConfig.packages.push({'name': 'mw-ai-chat-widget', 'location': '/derived/ui/mw-ai-chat-widget'});
...
dojoConfig.packages.push({'name': 'mw-feedback-dialog', 'location': '/derived/ui/mw-feedback-dialog'});
...
dojoConfig.packages.push({'name': 'mw-home-artifacts', 'location': '/toolbox/matlab/mwartifacts/mw-home-artifacts/js'});
...
dojoConfig.packages.push({'name': 'mw-login-ui', 'location': '/toolbox/matlab/login/web/app'});
...
dojoConfig.packages.push({'name': 'mw-network-utils', 'location': '/ui/mw-network-utils'});
dojoConfig.packages.push({'name': 'mw-notifications', 'location': '/derived/ui/mw-notifications'});
dojoConfig.packages.push({'name': 'mw-oauth-client', 'location': '/derived/ui/mw-oauth-client'});
...
dojoConfig.packages.push({'name': 'mw-rating', 'location': '/derived/ui/mw-rating'});
dojoConfig.packages.push({'name': 'mw-rating-feedback', 'location': '/derived/ui/mw-rating-feedback'});
...
dojoConfig.packages.push({'name': 'mw-server-to-client', 'location': '/ui/mw-server-to-client/mw-server-to-client'});
...
dojoConfig.packages.push({'name': 'mw-spf-ui', 'location': '/derived/ui/mw-spf-ui'});
...
dojoConfig.packages.push({'name': 'mw-titlepane', 'location': '/derived/ui/mw-titlepane'});
...
dojoConfig.packages.push({'name': 'notifications-bell-ui', 'location': '/toolbox/matlab/notifications/bell/notifications-bell-ui'});
dojoConfig.packages.push({'name': 'notifications-center-ui', 'location': '/toolbox/matlab/notifications/notifications_center_ui/notifications-center-ui'});
dojoConfig.packages.push({'name': 'object-hash', 'location': '/derived/3p/ui/object-hash'});
dojoConfig.packages.push({'name': 'outlinedatamodel', 'location': '/toolbox/matlab/outlinedatamodel/src'});
dojoConfig.packages.push({'name': 'outlinepanel', 'location': '/toolbox/matlab/outlinepanel/src'});
...
dojoConfig.packages.push({'name': 'panel-utilities-js', 'location': '/toolbox/matlab/preferences/utilities/src/js'});
dojoConfig.packages.push({'name': 'pathdataservice-js', 'location': '/toolbox/matlab/pathdataservice/pathdataservice-js'});
dojoConfig.packages.push({'name': 'pathtool_sidepanel-ui', 'location': '/toolbox/matlab/pathtool_sidepanel/pathtool_sidepanel-ui'});
...
dojoConfig.packages.push({'name': 'problemspanel', 'location': '/toolbox/matlab/problemspanel/src'});
...
dojoConfig.packages.push({'name': 'project-cfbaction-ui', 'location': '/toolbox/matlab/project/cfbfileinfoplugin/web-action/project-cfbaction-ui'});
...
dojoConfig.packages.push({'name': 'project-checks-ui', 'location': '/toolbox/matlab/project/views/checks_web/project-checks-ui'});
...
dojoConfig.packages.push({'name': 'project-customtasks-ui', 'location': '/toolbox/matlab/project/views/customtasks_web/project-customtasks-ui'});
...
dojoConfig.packages.push({'name': 'project-issues-ui', 'location': '/toolbox/matlab/project/views/issues_web/project-issues-ui'});
...
dojoConfig.packages.push({'name': 'project-sharing-tofmu', 'location': '/toolbox/shared/fmu_share_web'});
dojoConfig.packages.push({'name': 'project-sharing-togithub', 'location': '/toolbox/matlab/project/sharing/github_web'});
dojoConfig.packages.push({'name': 'project-sharing-totemplate', 'location': '/toolbox/simulink/project/sharing/totemplate_web'});
...
dojoConfig.packages.push({'name': 'project-store-lib', 'location': '/toolbox/matlab/project/views/store_web/project-store-lib'});
...
dojoConfig.packages.push({'name': 'pythonpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/python/pythonpanel-ui'});
...
dojoConfig.packages.push({'name': 'rtc_c_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_clike_language_support/c/src'});
dojoConfig.packages.push({'name': 'rtc_cpp_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_clike_language_support/cpp/src'});
dojoConfig.packages.push({'name': 'rtc_html_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_xml_language_support/html/src'});
...
dojoConfig.packages.push({'name': 'rtc_json_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_js_language_support/json/src'});
dojoConfig.packages.push({'name': 'rtc_markdown_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_markdown_language_support/js/src'});
...
dojoConfig.packages.push({'name': 'rtc_typescript_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_js_language_support/ts/src'});
...
dojoConfig.packages.push({'name': 'rtc_vrml_language_support', 'location': '/toolbox/sl3d/rtc_plugins/rtc_vrml_language_support/js/src'});
dojoConfig.packages.push({'name': 'rtc_xml_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_xml_language_support/xml/src'});
dojoConfig.packages.push({'name': 'rtc_yaml_language_support', 'location': '/toolbox/matlab/rtc_addons/rtclanguagesupport/rtc_yaml_language_support/js/src'});
dojoConfig.packages.push({'name': 'rtcaddon_legacylanguagesupport', 'location': '/toolbox/matlab/rtc_addons/shared/legacylanguagesupport/js'});
dojoConfig.packages.push({'name': 'rtcaddon_modernlanguagesupport', 'location': '/toolbox/matlab/rtc_addons/shared/modernlanguagesupport/js'});
...
dojoConfig.packages.push({'name': 'searchservice-js', 'location': '/toolbox/matlab/searchservice/searchservice-js'});
dojoConfig.packages.push({'name': 'settings', 'location': '/toolbox/matlab/settings_service/src/js/settings'});
dojoConfig.packages.push({'name': 'sf_file_action_plugin', 'location': '/toolbox/stateflow/sf_file_preview_plugin/js-action/sf_file_action_plugin'});
...
dojoConfig.packages.push({'name': 'showdownjs', 'location': '/derived/3p/ui/showdownjs'});
dojoConfig.packages.push({'name': 'sidebar', 'location': '/ui/layout/sidebar/js'});
dojoConfig.packages.push({'name': 'sidepanel-ui', 'location': '/toolbox/matlab/graphics/figuredatatools/sidepanel/sidepanel-ui'});
dojoConfig.packages.push({'name': 'simscapepanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/simscape/simscapepanel-ui'});
dojoConfig.packages.push({'name': 'simulinkpanel-ui', 'location': '/toolbox/matlab/preferences/simulinkpanel/simulinkpanel-ui'});
...
dojoConfig.packages.push({'name': 'slonline-ui', 'location': '/toolbox/simulink/online/web/slonline-ui'});
...
dojoConfig.packages.push({'name': 'testui-diagnostics-widgets', 'location': '/toolbox/matlab/testframework/shared/testbrowser/testdiagnostics-widgets/web'});
dojoConfig.packages.push({'name': 'timescope', 'location': '/toolbox/shared/dsp/webscopes/mltimescope/web/timescope/timescope'});
dojoConfig.packages.push({'name': 'tlcpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/tlc/tlcpanel-ui'});
...
dojoConfig.packages.push({'name': 'typeahead_dropdown', 'location': '/ui/search/typeahead_dropdown/js'});
dojoConfig.packages.push({'name': 'typeahead_search', 'location': '/ui/search/typeahead_search/js'});
...
dojoConfig.packages.push({'name': 'uix', 'location': '/ui/components/uix/js'});
dojoConfig.packages.push({'name': 'universalsearch', 'location': '/ui/search/search/js'});
...
dojoConfig.packages.push({'name': 'verilogpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/verilog/verilogpanel-ui'});
dojoConfig.packages.push({'name': 'vhdlpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/vhdl/vhdlpanel-ui'});
...
dojoConfig.packages.push({'name': 'webusbwebcam', 'location': '/toolbox/shared/webusbwebcam/webusbwebcam'});
...
dojoConfig.packages.push({'name': 'xmlpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/xml/xmlpanel-ui'});
dojoConfig.packages.push({'name': 'xstyle', 'location': '/derived/3p/ui/xstyle'});
dojoConfig.packages.push({'name': 'yamlpanel-ui', 'location': '/toolbox/matlab/preferences/languagepanels/yaml/yamlpanel-ui'});
